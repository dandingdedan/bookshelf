...
/**
 * Servlet implementation class ShowLikeBooks
 */
@WebServlet("/ShowLikeBooks")
public class ShowLikeBooks extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowLikeBooks() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(name==null||name.equals("")){
			...
			List<BookBean> records =s.findLikeBookByUserID(userID);
			...
			request.getRequestDispatcher("/showlikebook.jsp").forward(request, response);
		}
	}
